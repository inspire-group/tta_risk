...
class Normalized_WideResNet_CIFAR100(WideResNet):
    def __init__(self, device="cuda"):
        super(Normalized_WideResNet_CIFAR100, self).__init__(depth=28, num_classes=100, widen_factor=10, drop_rate=0.0)
    ...
    def forward(self, x):
        ...
        return super(Normalized_WideResNet_CIFAR100, self).forward(x)